                                ...
                                QStringList legAttribs)
{
	...
	//@RAIAN: Espessura da linha (vizinhanca)
	int width = legKeys.indexOf(WIDTH);
	//@RAIAN: FIM
