...
CellularSpace_ = {
	...
	-- @RAIAN: Novo load para as Vizinhanças
	add = function(self, cell)
		self.cObj_:addCell(cell.x, cell.y, cell.cObj_)
		table.insert(self.cells, cell)
		-- Recupera o maximo e minimo das colunas e linhas
	...
	load = function(self)
		...
		--@RAIAN: Seta o nome do layer (Preciso dele no loadNeighborhood do Environment)
...
function CellularSpace(attrTab)
	...
	if attrTab.xdim ~= nil then -- rectangular "virtual" cellular space
		...
		-- Recuperacao transferida para o metodo self.add
		-- attrTab.minRow = 1
		-- attrTab.minCol = 1
