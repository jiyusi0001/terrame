...
void ObsLegend::setOcurrence(int o)
{
    ocurrence = o;
}
...
void Attributes::setSlices(int i)
{
    slicesNumber = i;
}
...
void Attributes::setPrecisionNumber(int i)
{
    precNumber = i;
}
...
void Attributes::setType(TypesOfSubjects t)
{
    attribType = t;
}
...
void Attributes::setDataType(TypesOfData t)
{
    attribDataType = t;
}
...
void Attributes::setGroupMode(GroupingMode i)
{
    groupMode = i;
}
...
void Attributes::setStdDeviation(StdDev i)
{
    stdDev = i;
}
...
void Attributes::setVisible(bool v)
{
    visible = v;
}
...
void Attributes::setFont(const QFont &f)
{
    font = f;
}
...
void Attributes::setSymbol(const QString &s)
{
    symbol = s;
}
