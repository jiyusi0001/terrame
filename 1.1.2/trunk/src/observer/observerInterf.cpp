...
ObserverInterf::ObserverInterf( Subject* s )
{
    ObserverInterf::pImpl_->setSubject(s);
...
Observer * SubjectInterf::getObserverById(int observerId)
{
    return SubjectInterf::pImpl_->getObserverById(observerId);
}
