...
AgentObserverImage::AgentObserverImage(Subject * sub) : ObserverImage(sub)
{
...
bool AgentObserverImage::draw(QDataStream & in)
{
    bool drw = false, decoded = false;
    drw = ObserverImage::draw(in);
    cleanImage = true;
    className = "";
                                            ...
                                            const QString &className)
{
    ...
    for (int i = 0; i < attribs.size(); i++)
    {
        ...
        //// Define os tipos de subject que estão sendo observados
        //// por esse objeto
        //for (int i = 0; i < attribs.size(); i++)
        //{
